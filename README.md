...
You use state to set up data and the constructor (constructor not needed).  Then in order to render the data you use the render() method within the hook. {Class, constructor, Render}

2. Describe the different phases of the component lifecycle.

The mounting phase is when the component is being built out. 
Updating phase is when data in the component is being updated.
Unmounting phase is when the compnent is removed from the screen. 

3. Demonstrate an understanding of class component lifecycle methods.

We've mainly been using constuctor, render, and compnentDidMount. 

Constructor the first thing that is called - you need to call super and pass props (constructor is optional)
Render retruns the JSX of component. 
componentDidMount is where you load yoru data. 
...
Arrange, Act, Assert. 
Setting up code so you can test the app. 
Call the method or function. 
Check to see if expected reutrned matched actual return. 
